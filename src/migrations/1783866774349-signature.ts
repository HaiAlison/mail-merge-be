...
export class Signature1783866774349 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "signatures" DROP COLUMN "attachment_ids"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "signatures" ADD "attachment_ids" text NOT NULL DEFAULT '[]'`);
